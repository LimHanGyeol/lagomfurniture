...
public class ProductPageMakerUtils {
    private int totalcount;// 전체 게시물 개수
    private int pagenum;// 현재 페이지 번호
    private int contentnum = 6;// 한 페이지에 보일 게시물의 개수
    ...
    public void setCurrentblock(int pagenum) {
        ...
        this.currentblock = pagenum / 5; // 1페이지당 5블록
        if (pagenum % 5 > 0) {
            this.currentblock++;
    ...
    public void setLastblock(int totalcount) {
        ...
        //6,5
        //전체 게시글의 개수를 한페이지 표시할 게시물 개수와 페이지 번호를 곱한것으로 나눈ㄴ다..
